...
Most of these come down to network reality or how xuetangx serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

xuetangx rate-limits like any public site. xtx already paces
...
Where a surface is gated, xtx reads a cookie or token you supply
...
`xtx`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what xtx actually did
